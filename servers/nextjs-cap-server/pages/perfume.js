...
function ShowLoading({ isLoading }) {
  if (isLoading) {
    return (
      <>
        <div className="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4 w-64 flex items-center justify-center">
...
function ShowError({ error }) {
  if (error) {
    return (
      <>
        <div className="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4 w-64">
...
function ShowPerfume({ perfume }) {
  if (perfume) {
    return (
      <>
        <div className="bg-gray-50 shadow-md rounded px-4 pt-4 pb-4 mb-4 w-96">
          <Image
            src={perfume}
            width={512}
            height={512}
